...
运行：
    uv run pytest tests/integration/test_gallery_server_library.py
    # 或：uv run python -m tests.integration.test_gallery_server_library
"""
...
from javlibraryscrapy.library.scanner import save_index, scan_library, MovieEntry  # noqa: E402
...
def test_path_normalization():
    ...
    from javlibraryscrapy.server.services.library import normalize_path_for_compare as norm
