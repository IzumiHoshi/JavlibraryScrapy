...
# 必须先 monkey-patch 再 import gallery_server
import library_refresher  # noqa: E402
from library_scanner import save_index, scan_library  # noqa: E402
...
def main():
    ...
    from gallery_server import RescanJob, RescanQueue

    # 用 monkey-patch 让 refresh_library_movie 立刻返回 ok
    real_refresh = library_refresher.refresh_library_movie
    real_in_gallery = None  # gallery_server 在 import 时缓存了引用
    try:
        import gallery_server
        real_in_gallery = gallery_server.refresh_library_movie
    except Exception:
        pass
    ...
    if real_in_gallery is not None:
        gallery_server.refresh_library_movie = fake_refresh
